...
class MockTicketClient implements TicketClient {
  const MockTicketClient();

  @override
  Future<List<Offer>> getOffers() async =>
      OffersResponse.fromJson(jsonDecode(_offersJson)).offers;

  @override
  Future<List<TicketsOffer>> getTicketOffers() async =>
      TicketsOffersResponse.fromJson(jsonDecode(_ticketOffersJson))
          .ticketsOffers;

  @override
  Future<List<Ticket>> getTickets() async =>
      TicketsResponse.fromJson(jsonDecode(_ticketsJson)).tickets;
}
