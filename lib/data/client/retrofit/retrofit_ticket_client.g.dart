...
part of 'retrofit_ticket_client.dart';
...
class _RetrofitTicketClient implements RetrofitTicketClient {
  ...
  Future<List<TicketsOffer>> getTicketOffers() async {
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<TicketsOffer>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => TicketsOffer.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
